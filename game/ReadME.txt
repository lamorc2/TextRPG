...
Project Overview:
	...
	This is a console-based text RPG created almost entirely from scratch within C++ as a personal project to :
	 ...
	 [insert title] is a text-based RPG set in fantastical world where shadows are overtaking the population, and your friends. You must navigate your way through 
	 turn-based combat and puzzles to save your friends and return to your world. 
